...
class ApiServiceForReservation {
    object ApiServicesForReservation {
        const val API_USERNAME = "user"
        const val API_PASSWORD = "myPassword"

        val reservationsApiService : ReservationsApiService by lazy {
            val client = ApiServiceForReservation.ApiServicesForReservation.getUnsafeOkHttpClient()
            ...
            Retrofit.Builder()
                ...
                .build()
                .create(ReservationsApiService::class.java)
        }
